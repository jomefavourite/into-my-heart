...
const HeroSection = (): JSX.Element => {
  ...
  return (
    <section className='relative w-full h-[650px]'>
      {/* Navigation Bar */}
      <header className='flex w-full items-center justify-between px-20 py-[18px] bg-white shadow-[0px_0px_15px_#0000000d]'>
        {/* Logo */}
        <Logo />
      ...
      <div className='flex flex-col items-start gap-7'>
        ...
        <div className='flex flex-col w-full items-start gap-3'>
          <h1 className="[font-family:'Onest',Helvetica] text-[44px] leading-[53px] tracking-[-0.44px] font-semibold text-[#313131]">
            The Engaging Way To Keep{' '}
            <span className='text-[#1c1c1c]'>God&apos;s Word</span> In Your
            Heart
          </h1>

          <p className="[font-family:'Inter',Helvetica] font-medium text-[#707070] text-base tracking-[0.16px] leading-6">
